...
|14|Response Code `400 Bad Request`<br>Massage: `"name" containce invalid characters"`<br>Enter five Latin letters starting with a capital letter and send the request with an existing "group"|name: "Lukcy"<br>group: "4"|FAILED|BR-7|Medium|Normal|
|15|Response Code `400 Bad Request`<br>Massage: `"name" containce invalid characters:`<br>Enter a number and send the request with an existing "group"| name: "5"| FAILED | BR-8|Medium|Normal|
|16|Response Code `400 Bad Request`<br>Massage: `"name" containce invalid characters: `<br>Enter a punctuation symbol and send the request with an existung "group"|name: "!"|FAILED|BR-9|Medium|Normal|
|17|Response Code `400 Bsd Request`<br>Massage: `"name" containce invalid characters:`<br>Enter a special symbol and send the request with an existing "group"|name: "#"|FAILED|BR-10|Medium|Normal|
